...
class Notifications:
    ...
    def __str__(self):
        ...
        if not self.nbNotifications:
            output.append('No notification')
        else:
            output.append('{} notifications'.format(self.nbNotifications))
        ...
        for repositoryName, _ in self.repositoryLastActivityDates:
            ...
            for notification in notifications:
                ...
                output.append('----Read ↗️ | href={}'.format(self.getLink(notification)))

                (command, param1, param2) = self.getMarkReadCommand(notification)
                output.append('----Mark as read| bash={} param1={} param2={} terminal=false refresh=true'.format(
                    command,
                    param1,
                    param2,
                ))
